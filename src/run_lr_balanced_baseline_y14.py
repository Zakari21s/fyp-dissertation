"""
Train and evaluate Logistic Regression baseline with class_weight="balanced" for disk failure prediction using y_14.
...
def setup_logging(log_dir: Path, log_level: str, experiment_name: str) -> logging.Logger:
    ...
    log_file = log_dir / f"lr_balanced_y14_{experiment_name}.log"
...
def write_reports(results: BaselineResults, logger: logging.Logger) -> None:
    ...
    # JSON report
    json_path = reports_dir / f"baseline_y14_lr_balanced_results_{experiment_name}.json"
    ...
    # Markdown report
    md_path = reports_dir / f"baseline_y14_lr_balanced_results_{experiment_name}.md"
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default='y_14',
        help='Label column name (default: y_14)'
    )
    parser.add_argument(
        '--max_train_rows',
        type=int,
