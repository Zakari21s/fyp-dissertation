"""
Train and evaluate Logistic Regression baseline with class_weight="balanced" for disk failure prediction using y_30.
...
def setup_logging(log_dir: Path, log_level: str, experiment_name: str) -> logging.Logger:
    ...
    log_file = log_dir / f"lr_balanced_y30_{experiment_name}.log"
...
def load_split_data_iterative(
    ...
    Args:
        ...
        label_col: Label column name (e.g., 'y_30')
...
def write_reports(results: BaselineResults, logger: logging.Logger) -> None:
    ...
    # JSON report
    json_path = reports_dir / f"baseline_y30_lr_balanced_results_{experiment_name}.json"
    ...
    # Markdown report
    md_path = reports_dir / f"baseline_y30_lr_balanced_results_{experiment_name}.md"
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default='y_30',
        help='Label column name (default: y_30)'
    )
    parser.add_argument(
        '--max_train_rows',
        type=int,
