"""
Train and evaluate Random Forest baseline for disk failure prediction using y_7.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Train and evaluate Random Forest baseline for disk failure prediction using y_7'
    )
    parser.add_argument(
        '--experiment',
        type=str,
